 ...
 */
public class UntilGenerate<E> extends BaseStoppableGenerator<E> {
     ...
     * @param wrapped {@link StoppableGenerator}
     * @param test {@link UnaryPredicate}
     */
    public UntilGenerate(UnaryPredicate<? super E> test, StoppableGenerator<? extends E> wrapped) {
